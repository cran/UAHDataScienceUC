...
kmeans_ <- function(
  ...
  centers <- switch(
    init,
    # ... randomly
    random_init(as.matrix(data), centers, learn, waiting, ...),
    # ... using the kmeans++ algorithm
    kmeanspp_init(as.matrix(data), centers, learn, waiting, ...),
...
random_init <- function(data, k, learn, waiting, ...) {
  if (learn) {
...
kmeanspp_init <- function(data, k, learn, waiting, ...) {
  if (learn) {
